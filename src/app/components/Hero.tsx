...
const HeroSection = () => {
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center bg-black text-white px-10 md:px-16 overflow-hidden"
    >
      {/* SVG Background */}
      <div
        className="absolute w-[800px] h-[800px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0" // Centered, smaller, and behind content
        style={{
          backgroundImage:
            "url('https://do6gp1uxl3luu.cloudfront.net/assets/Lines.svg')",
          backgroundRepeat: "no-repeat",
          backgroundSize: "contain", // Use contain to ensure the whole SVG fits
          backgroundPosition: "center",
          filter: "invert(100%) brightness(200%)", // white lines
          transform: "rotate(3deg) translate(-50%, -50%)", // Rotated right and re-centered after rotation
        }}
      ></div>

      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between w-full max-w-7xl mx-auto -mt-30">
        {/* LEFT SIDE - Text */}
        <motion.div
        ...
        >
          <div className="bg-[#0d0d0d] text-[#e5e5e5] rounded-xl shadow-2xl p-8 font-mono text-[15px] w-[600px]">
